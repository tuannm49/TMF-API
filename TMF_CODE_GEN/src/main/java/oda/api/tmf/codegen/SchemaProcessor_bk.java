...
public class SchemaProcessor_bk {
    ...
    public SchemaProcessor_bk(OpenAPI openAPI, String apiDirGen, Map<String, String[]> directoryMap, Map<String, String[]> configMap) {
    ...
    private void generateEntityClass(String schemaName, Schema schema, String fileName, String outputDir, String packageName, Set<String> visitedSchemas) throws IOException {
        if (!findIgnoreByFileName(configMap, schemaName)) {
            ...
            sb.append("import oda.sid.tmf.entity.others.*;\n");
            sb.append("import oda.sid.tmf.entity.common.*;\n");
            sb.append("import oda.sid.tmf.entity.customer.*;\n");
            sb.append("import oda.sid.tmf.entity.party.*;\n");
            sb.append("import oda.sid.tmf.entity.product.*;\n");
            sb.append("import oda.sid.tmf.entity.resource.*;\n");
            sb.append("import oda.sid.tmf.entity.sale.*;\n");
            sb.append("import oda.sid.tmf.entity.service.*;\n");
            sb.append("import oda.sid.tmf.entity.base.*;\n");
//            if (baseClass != null) {
...
//            sb.append("@Document\n");
            ...
            if ((baseClass!=null&&baseClass.endsWith("Ref"))||schemaName.contains("RefOrValue") || schemaName.equals("PartyRefOrPartyRoleRef")) {
                sb.append("    @Override\n");
