...
public class ExportJobStateChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ExportJobStateChangeEvent_id")
    ...
    @JsonBackReference
    private ExportJobStateChangeEventPayload event;
