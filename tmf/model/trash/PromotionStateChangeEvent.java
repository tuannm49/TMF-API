...
public class PromotionStateChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "PromotionStateChangeEvent_id")
    ...
    @JsonBackReference
    private PromotionStateChangeEventPayload event;
