...
public class PolicyDomainStateChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "PolicyDomainStateChangeEvent_id")
    ...
    @JsonBackReference
    private PolicyDomainStateChangeEventPayload event;
