...
public class ClosedLoopActivitySpecificationDeleteEvent_FVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopActivitySpecificationDeleteEvent_FVO_id")
