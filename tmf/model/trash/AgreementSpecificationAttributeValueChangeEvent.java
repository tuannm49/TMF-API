...
public class AgreementSpecificationAttributeValueChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "AgreementSpecificationAttributeValueChangeEvent_id")
