...
public class PaymentMethodCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "PaymentMethodCreateEvent_id")
    ...
    @JsonBackReference
    private PaymentMethodCreateEventPayload event;
