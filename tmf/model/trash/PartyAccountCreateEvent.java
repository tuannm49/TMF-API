...
public class PartyAccountCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "PartyAccountCreateEvent_id")
    ...
    @JsonBackReference
    private PartyAccountCreateEventPayload event;
