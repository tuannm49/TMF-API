...
public class Customer360CreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "Customer360CreateEvent_id")
    ...
    @JsonBackReference
    private Customer360CreateEventPayload event;
