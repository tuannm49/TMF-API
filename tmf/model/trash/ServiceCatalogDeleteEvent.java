...
public class ServiceCatalogDeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ServiceCatalogDeleteEvent_id")
    ...
    @JsonBackReference
    private ServiceCatalogDeleteEventPayload event;
