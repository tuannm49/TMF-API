...
public class ClosedLoopWorkflowActivitySpecification_MVO implements java.io.Serializable {
    ...
    @OneToMany
    @JoinColumn(name = "ClosedLoopWorkflowActivitySpecification_MVO_id")
