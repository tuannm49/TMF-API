...
public class ImportJobStateChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ImportJobStateChangeEvent_id")
    ...
    @JsonBackReference
    private ImportJobStateChangeEventPayload event;
