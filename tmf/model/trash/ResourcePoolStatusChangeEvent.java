...
public class ResourcePoolStatusChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ResourcePoolStatusChangeEvent_id")
    ...
    @JsonBackReference
    private ResourcePoolStatusChangeEventPayload event;
