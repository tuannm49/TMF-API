...
public class ProblemUngroupCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ProblemUngroupCreateEvent_id")
    ...
    @JsonBackReference
    private ProblemUngroupCreateEventPayload event;
