...
public class ResourceUsageCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ResourceUsageCreateEvent_id")
    ...
    @JsonBackReference
    private ResourceUsageCreateEventPayload event;
