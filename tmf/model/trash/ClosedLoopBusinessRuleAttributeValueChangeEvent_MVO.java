...
public class ClosedLoopBusinessRuleAttributeValueChangeEvent_MVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopBusinessRuleAttributeValueChangeEvent_MVO_id")
