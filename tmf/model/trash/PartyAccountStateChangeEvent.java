...
public class PartyAccountStateChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "PartyAccountStateChangeEvent_id")
    ...
    @JsonBackReference
    private PartyAccountStateChangeEventPayload event;
