...
public class ClosedLoopWorkflowActivitySpecification_FVO implements java.io.Serializable {
    ...
    @OneToMany
    @JoinColumn(name = "ClosedLoopWorkflowActivitySpecification_FVO_id")
    ...
    @JsonBackReference
    private ClosedLoopGroup_FVO group;
}
