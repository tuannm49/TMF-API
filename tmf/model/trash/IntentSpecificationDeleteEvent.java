...
public class IntentSpecificationDeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "IntentSpecificationDeleteEvent_id")
    ...
    @JsonBackReference
    private IntentSpecificationDeleteEventPayload event;
