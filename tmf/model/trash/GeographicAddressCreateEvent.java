...
public class GeographicAddressCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "GeographicAddressCreateEvent_id")
    ...
    @JsonBackReference
    private GeographicAddressCreateEventPayload event;
