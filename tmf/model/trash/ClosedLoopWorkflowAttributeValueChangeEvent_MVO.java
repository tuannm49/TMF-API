...
public class ClosedLoopWorkflowAttributeValueChangeEvent_MVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopWorkflowAttributeValueChangeEvent_MVO_id")
    ...
    @JsonBackReference
    private ClosedLoopWorkflowAttributeValueChangeEventPayload event;
