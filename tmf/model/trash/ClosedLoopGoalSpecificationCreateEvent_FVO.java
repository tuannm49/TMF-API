...
public class ClosedLoopGoalSpecificationCreateEvent_FVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopGoalSpecificationCreateEvent_FVO_id")
    ...
    @JsonBackReference
    private ClosedLoopGoalSpecificationCreateEventPayload event;
