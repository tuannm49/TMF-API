...
public class ShippingOrderDeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ShippingOrderDeleteEvent_id")
    ...
    @JsonBackReference
    private ShippingOrderDeleteEventPayload event;
