...
public class PermissionSetCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "PermissionSetCreateEvent_id")
    ...
    @JsonBackReference
    private PermissionSetCreateEventPayload event;
