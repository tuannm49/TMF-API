...
public class QuoteAttributeValueChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "QuoteAttributeValueChangeEvent_id")
    ...
    @JsonBackReference
    private QuoteAttributeValueChangePayload event;
