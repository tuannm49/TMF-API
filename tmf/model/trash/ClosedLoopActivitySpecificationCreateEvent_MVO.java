...
public class ClosedLoopActivitySpecificationCreateEvent_MVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopActivitySpecificationCreateEvent_MVO_id")
    ...
    @JsonBackReference
    private ClosedLoopActivitySpecificationCreateEventPayload event;
