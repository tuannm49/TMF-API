...
public class BillFormatStateChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "BillFormatStateChangeEvent_id")
    ...
    @JsonBackReference
    private BillFormatStateChangeEventPayload event;
