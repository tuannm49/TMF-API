...
public class ManagedPolicyEventCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ManagedPolicyEventCreateEvent_id")
    ...
    @JsonBackReference
    private ManagedPolicyEventCreateEventPayload event;
