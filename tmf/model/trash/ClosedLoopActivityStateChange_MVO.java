...
public class ClosedLoopActivityStateChange_MVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopActivityStateChange_MVO_id")
    ...
    @JsonBackReference
    private ClosedLoopActivityStateChangeEventPayload event;
