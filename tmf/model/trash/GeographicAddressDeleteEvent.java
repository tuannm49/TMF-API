...
public class GeographicAddressDeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "GeographicAddressDeleteEvent_id")
    ...
    @JsonBackReference
    private GeographicAddressDeleteEventPayload event;
