...
public class BillingAccountStateChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "BillingAccountStateChangeEvent_id")
    ...
    @JsonBackReference
    private BillingAccountStateChangeEventPayload event;
