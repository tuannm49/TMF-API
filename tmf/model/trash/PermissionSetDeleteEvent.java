...
public class PermissionSetDeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "PermissionSetDeleteEvent_id")
    ...
    @JsonBackReference
    private PermissionSetDeleteEventPayload event;
