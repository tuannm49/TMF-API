...
public class ClosedLoopActivityCreateEvent_FVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopActivityCreateEvent_FVO_id")
    ...
    @JsonBackReference
    private ClosedLoopActivityCreateEventPayload event;
