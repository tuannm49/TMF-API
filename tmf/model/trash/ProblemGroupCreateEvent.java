...
public class ProblemGroupCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ProblemGroupCreateEvent_id")
    ...
    @JsonBackReference
    private ProblemGroupCreateEventPayload event;
