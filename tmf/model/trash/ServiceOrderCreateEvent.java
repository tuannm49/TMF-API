...
public class ServiceOrderCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ServiceOrderCreateEvent_id")
    ...
    @JsonBackReference
    private ServiceOrderCreateEventPayload event;
