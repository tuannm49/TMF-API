...
public class ResourcePoolDeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ResourcePoolDeleteEvent_id")
    ...
    @JsonBackReference
    private ResourcePoolDeleteEventPayload event;
