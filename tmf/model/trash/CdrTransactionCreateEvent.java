...
public class CdrTransactionCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "CdrTransactionCreateEvent_id")
    ...
    @JsonBackReference
    private CdrTransactionCreateEventPayload event;
