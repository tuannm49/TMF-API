...
public class ApiProductOrderCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ApiProductOrderCreateEvent_id")
    ...
    @JsonBackReference
    private ApiProductOrderCreateEventPayload event;
