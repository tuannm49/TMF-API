...
public class MeasurementCollectionJobExecutionStateChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "MeasurementCollectionJobExecutionStateChangeEvent_id")
