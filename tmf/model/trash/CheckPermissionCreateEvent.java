...
public class CheckPermissionCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "CheckPermissionCreateEvent_id")
    ...
    @JsonBackReference
    private CheckPermissionCreateEventPayload event;
