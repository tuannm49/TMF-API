...
public class AvailabilityCheckCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "AvailabilityCheckCreateEvent_id")
    ...
    @JsonBackReference
    private AvailabilityCheckCreateEventPayload event;
