...
public class WorkOrderStateChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "WorkOrderStateChangeEvent_id")
    ...
    @JsonBackReference
    private WorkOrderStateChangeEventPayload event;
