...
public class ClosedLoopWorkflowActivityStateChange_MVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopWorkflowActivityStateChange_MVO_id")
    ...
    @JsonBackReference
    private ClosedLoopWorkflowActivityStateChangeEventPayload event;
