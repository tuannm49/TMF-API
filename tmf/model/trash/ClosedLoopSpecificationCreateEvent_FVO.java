...
public class ClosedLoopSpecificationCreateEvent_FVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopSpecificationCreateEvent_FVO_id")
    ...
    @JsonBackReference
    private ClosedLoopSpecificationCreateEventPayload event;
