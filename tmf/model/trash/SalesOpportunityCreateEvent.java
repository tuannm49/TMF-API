...
public class SalesOpportunityCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "SalesOpportunityCreateEvent_id")
    ...
    @JsonBackReference
    private SalesOpportunityCreateEventPayload event;
