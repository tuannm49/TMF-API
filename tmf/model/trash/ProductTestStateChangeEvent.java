...
public class ProductTestStateChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ProductTestStateChangeEvent_id")
    ...
    @JsonBackReference
    private ProductTestStateChangeEventPayload event;
