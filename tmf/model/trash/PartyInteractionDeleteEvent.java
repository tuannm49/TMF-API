...
public class PartyInteractionDeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "PartyInteractionDeleteEvent_id")
    ...
    @JsonBackReference
    private PartyInteractionDeleteEventPayload event;
