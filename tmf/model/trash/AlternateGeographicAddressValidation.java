...
public class AlternateGeographicAddressValidation implements java.io.Serializable {
    ...
    @OneToMany
    @JoinColumn(name = "AlternateGeographicAddressValidation_id")
    ...
    @JoinColumn(name = "AlternateGeographicAddressValidation_id")
    @JsonManagedReference
    private List<GeographicAddressRelationship> geographicAddressRelationship;
    ...
    @JsonBackReference
    private GeographicSiteRefOrValue geographicSite;
