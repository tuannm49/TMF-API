...
public class ResourceCandidateDeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ResourceCandidateDeleteEvent_id")
    ...
    @JsonBackReference
    private ResourceCandidateDeleteEventPayload event;
