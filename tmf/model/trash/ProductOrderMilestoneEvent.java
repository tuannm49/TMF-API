...
public class ProductOrderMilestoneEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ProductOrderMilestoneEvent_id")
    ...
    @JsonBackReference
    private ProductOrderMilestonePayload event;
