...
public class ClosedLoopSpecificationAttributeValueChangeEvent_FVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopSpecificationAttributeValueChangeEvent_FVO_id")
