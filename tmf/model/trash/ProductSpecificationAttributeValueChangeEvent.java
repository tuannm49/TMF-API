...
public class ProductSpecificationAttributeValueChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ProductSpecificationAttributeValueChangeEvent_id")
