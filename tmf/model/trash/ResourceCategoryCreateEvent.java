...
public class ResourceCategoryCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ResourceCategoryCreateEvent_id")
    ...
    @JsonBackReference
    private ResourceCategoryCreateEventPayload event;
