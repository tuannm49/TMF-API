...
public class ClosedLoopGoalSpecificationDeleteEvent_MVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopGoalSpecificationDeleteEvent_MVO_id")
    ...
    @JsonBackReference
    private ClosedLoopGoalSpecificationDeleteEventPayload event;
