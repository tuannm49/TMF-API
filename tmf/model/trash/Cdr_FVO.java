...
public class Cdr_FVO implements java.io.Serializable {
    @ManyToOne
    ...
    @OneToMany
    @JoinColumn(name = "Cdr_FVO_id")
    @JsonManagedReference
    private List<CdrCharacteristic_FVO> cdrCharacteristic;
    ...
    @JsonBackReference
    private ProductRef_FVO productRef;
    ...
    @JoinColumn(name = "Cdr_FVO_id")
    @JsonManagedReference
    private List<RatedCdr_FVO> ratedCdr;
}
