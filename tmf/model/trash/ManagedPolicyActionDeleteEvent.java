...
public class ManagedPolicyActionDeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ManagedPolicyActionDeleteEvent_id")
    ...
    @JsonBackReference
    private ManagedPolicyActionDeleteEventPayload event;
