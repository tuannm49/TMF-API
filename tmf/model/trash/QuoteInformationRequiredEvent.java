...
public class QuoteInformationRequiredEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "QuoteInformationRequiredEvent_id")
    ...
    @JsonBackReference
    private QuoteInformationRequiredEventPayload event;
