...
public class ClosedLoopBusinessRuleSpecificationDeleteEvent_MVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopBusinessRuleSpecificationDeleteEvent_MVO_id")
    ...
    @JsonBackReference
    private ClosedLoopBusinessRuleSpecificationDeleteEventPayload event;
