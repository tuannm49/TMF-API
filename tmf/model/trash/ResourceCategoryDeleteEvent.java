...
public class ResourceCategoryDeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ResourceCategoryDeleteEvent_id")
    ...
    @JsonBackReference
    private ResourceCategoryDeleteEventPayload event;
