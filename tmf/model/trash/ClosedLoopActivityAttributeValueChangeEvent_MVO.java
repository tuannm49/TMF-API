...
public class ClosedLoopActivityAttributeValueChangeEvent_MVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopActivityAttributeValueChangeEvent_MVO_id")
    ...
    @JsonBackReference
    private ClosedLoopActivityAttributeValueChangeEventPayload event;
