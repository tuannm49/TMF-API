...
public class ProblemUngroupStateChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ProblemUngroupStateChangeEvent_id")
    ...
    @JsonBackReference
    private ProblemUngroupStateChangeEventPayload event;
