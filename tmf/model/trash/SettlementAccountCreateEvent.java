...
public class SettlementAccountCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "SettlementAccountCreateEvent_id")
    ...
    @JsonBackReference
    private SettlementAccountCreateEventPayload event;
