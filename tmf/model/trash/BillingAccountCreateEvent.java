...
public class BillingAccountCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "BillingAccountCreateEvent_id")
    ...
    @JsonBackReference
    private BillingAccountCreateEventPayload event;
