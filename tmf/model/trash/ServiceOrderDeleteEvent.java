...
public class ServiceOrderDeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ServiceOrderDeleteEvent_id")
    ...
    @JsonBackReference
    private ServiceOrderDeleteEventPayload event;
