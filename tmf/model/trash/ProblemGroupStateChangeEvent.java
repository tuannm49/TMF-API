...
public class ProblemGroupStateChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ProblemGroupStateChangeEvent_id")
    ...
    @JsonBackReference
    private ProblemGroupStateChangeEventPayload event;
