...
public class ClosedLoopDeleteEvent_FVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopDeleteEvent_FVO_id")
    ...
    @JsonBackReference
    private ClosedLoopDeleteEventPayload event;
