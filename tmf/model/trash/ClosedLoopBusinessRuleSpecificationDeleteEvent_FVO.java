...
public class ClosedLoopBusinessRuleSpecificationDeleteEvent_FVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopBusinessRuleSpecificationDeleteEvent_FVO_id")
