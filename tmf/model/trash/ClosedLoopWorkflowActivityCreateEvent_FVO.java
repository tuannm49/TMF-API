...
public class ClosedLoopWorkflowActivityCreateEvent_FVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopWorkflowActivityCreateEvent_FVO_id")
    ...
    @JsonBackReference
    private ClosedLoopWorkflowActivityCreateEventPayload event;
