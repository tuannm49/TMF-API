...
public class ClosedLoopActivitySpecificationDeleteEvent_MVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopActivitySpecificationDeleteEvent_MVO_id")
    ...
    @JsonBackReference
    private ClosedLoopActivitySpecificationDeleteEventPayload event;
