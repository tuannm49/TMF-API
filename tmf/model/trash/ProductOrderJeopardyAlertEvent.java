...
public class ProductOrderJeopardyAlertEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ProductOrderJeopardyAlertEvent_id")
    ...
    @JsonBackReference
    private ProductOrderJeopardyAlertPayload event;
