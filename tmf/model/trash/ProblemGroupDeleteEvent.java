...
public class ProblemGroupDeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ProblemGroupDeleteEvent_id")
    ...
    @JsonBackReference
    private ProblemGroupDeleteEventPayload event;
