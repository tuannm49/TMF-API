...
public class CustomerBillStateChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "CustomerBillStateChangeEvent_id")
    ...
    @JsonBackReference
    private CustomerBillStateChangeEventPayload event;
