...
public class ResourceUsageDeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ResourceUsageDeleteEvent_id")
    ...
    @JsonBackReference
    private ResourceUsageDeleteEventPayload event;
