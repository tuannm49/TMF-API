...
public class IntentReportCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "IntentReportCreateEvent_id")
    ...
    @JsonBackReference
    private IntentReportCreateEventPayload event;
