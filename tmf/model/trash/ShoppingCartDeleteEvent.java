...
public class ShoppingCartDeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ShoppingCartDeleteEvent_id")
    ...
    @JsonBackReference
    private ShoppingCartDeleteEventPayload event;
