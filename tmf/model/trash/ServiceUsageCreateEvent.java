...
public class ServiceUsageCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ServiceUsageCreateEvent_id")
    ...
    @JsonBackReference
    private ServiceUsageCreateEventPayload event;
