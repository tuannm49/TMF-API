...
public class SalesOpportunityDeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "SalesOpportunityDeleteEvent_id")
    ...
    @JsonBackReference
    private SalesOpportunityDeleteEventPayload event;
