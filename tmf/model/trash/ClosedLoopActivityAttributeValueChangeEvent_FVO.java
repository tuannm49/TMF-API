...
public class ClosedLoopActivityAttributeValueChangeEvent_FVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopActivityAttributeValueChangeEvent_FVO_id")
