...
public class ClosedLoopBusinessRuleSpecificationCreateEvent_MVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopBusinessRuleSpecificationCreateEvent_MVO_id")
