...
public class ServiceOrderMilestoneEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ServiceOrderMilestoneEvent_id")
    ...
    @JsonBackReference
    private ServiceOrderMilestoneEventPayload event;
