...
public class PolicyDomainDeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "PolicyDomainDeleteEvent_id")
    ...
    @JsonBackReference
    private PolicyDomainDeleteEventPayload event;
