...
public class ServiceCandidateCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ServiceCandidateCreateEvent_id")
    ...
    @JsonBackReference
    private ServiceCandidateCreateEventPayload event;
