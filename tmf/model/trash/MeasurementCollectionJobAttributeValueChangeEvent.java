...
public class MeasurementCollectionJobAttributeValueChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "MeasurementCollectionJobAttributeValueChangeEvent_id")
