...
public class ServiceProblemStateChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ServiceProblemStateChangeEvent_id")
    ...
    @JsonBackReference
    private ServiceProblemStateChangeEventPayload event;
