...
public class ShippingOrderStateChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ShippingOrderStateChangeEvent_id")
    ...
    @JsonBackReference
    private ShippingOrderStateChangeEventPayload event;
