...
public class ManagedPolicyDeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ManagedPolicyDeleteEvent_id")
    ...
    @JsonBackReference
    private ManagedPolicyDeleteEventPayload event;
