...
public class ResourcePoolCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ResourcePoolCreateEvent_id")
    ...
    @JsonBackReference
    private ResourcePoolCreateEventPayload event;
