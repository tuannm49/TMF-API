...
public class SalesLeadStateChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "SalesLeadStateChangeEvent_id")
    ...
    @JsonBackReference
    private SalesLeadStateChangeEventPayload event;
