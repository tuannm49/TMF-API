...
public class ServiceCategoryCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ServiceCategoryCreateEvent_id")
    ...
    @JsonBackReference
    private ServiceCategoryCreateEventPayload event;
