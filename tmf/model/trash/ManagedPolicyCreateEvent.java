...
public class ManagedPolicyCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ManagedPolicyCreateEvent_id")
    ...
    @JsonBackReference
    private ManagedPolicyCreateEventPayload event;
