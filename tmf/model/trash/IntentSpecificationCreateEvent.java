...
public class IntentSpecificationCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "IntentSpecificationCreateEvent_id")
    ...
    @JsonBackReference
    private IntentSpecificationCreateEventPayload event;
