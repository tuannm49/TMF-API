...
public class ClosedLoopBusinessRuleSpecificationCreateEvent_FVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopBusinessRuleSpecificationCreateEvent_FVO_id")
    ...
    @JsonBackReference
    private ClosedLoopBusinessRuleSpecificationCreateEventPayload event;
