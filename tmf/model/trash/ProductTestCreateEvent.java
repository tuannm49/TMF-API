...
public class ProductTestCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ProductTestCreateEvent_id")
    ...
    @JsonBackReference
    private ProductTestCreateEventPayload event;
