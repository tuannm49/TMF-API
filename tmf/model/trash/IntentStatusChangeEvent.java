...
public class IntentStatusChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "IntentStatusChangeEvent_id")
    ...
    @JsonBackReference
    private IntentStatusChangeEventPayload event;
