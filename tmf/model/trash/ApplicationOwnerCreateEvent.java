...
public class ApplicationOwnerCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ApplicationOwnerCreateEvent_id")
    ...
    @JsonBackReference
    private ApplicationOwnerCreateEventPayload event;
