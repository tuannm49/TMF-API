...
public class ManagedPolicyStateChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ManagedPolicyStateChangeEvent_id")
    ...
    @JsonBackReference
    private ManagedPolicyStateChangeEventPayload event;
