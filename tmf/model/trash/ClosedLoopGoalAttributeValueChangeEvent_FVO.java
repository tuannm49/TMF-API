...
public class ClosedLoopGoalAttributeValueChangeEvent_FVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopGoalAttributeValueChangeEvent_FVO_id")
    ...
    @JsonBackReference
    private ClosedLoopGoalAttributeValueChangeEventPayload event;
