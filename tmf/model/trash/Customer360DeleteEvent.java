...
public class Customer360DeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "Customer360DeleteEvent_id")
    ...
    @JsonBackReference
    private Customer360DeleteEventPayload event;
