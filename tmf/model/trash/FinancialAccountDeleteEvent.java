...
public class FinancialAccountDeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "FinancialAccountDeleteEvent_id")
    ...
    @JsonBackReference
    private FinancialAccountDeleteEventPayload event;
