...
public class ClosedLoopActivityDeleteEvent_FVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopActivityDeleteEvent_FVO_id")
    ...
    @JsonBackReference
    private ClosedLoopActivityDeleteEventPayload event;
