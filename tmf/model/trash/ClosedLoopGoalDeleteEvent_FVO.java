...
public class ClosedLoopGoalDeleteEvent_FVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopGoalDeleteEvent_FVO_id")
    ...
    @JsonBackReference
    private ClosedLoopGoalDeleteEventPayload event;
