...
public class ClosedLoopAttributeValueChangeEvent_MVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopAttributeValueChangeEvent_MVO_id")
    ...
    @JsonBackReference
    private ClosedLoopAttributeValueChangeEventPayload event;
