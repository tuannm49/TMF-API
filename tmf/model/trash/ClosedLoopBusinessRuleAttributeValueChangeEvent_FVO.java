...
public class ClosedLoopBusinessRuleAttributeValueChangeEvent_FVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopBusinessRuleAttributeValueChangeEvent_FVO_id")
    ...
    @JsonBackReference
    private ClosedLoopBusinessRuleAttributeValueChangeEventPayload event;
