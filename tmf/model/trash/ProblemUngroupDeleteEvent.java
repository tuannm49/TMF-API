...
public class ProblemUngroupDeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ProblemUngroupDeleteEvent_id")
    ...
    @JsonBackReference
    private ProblemUngroupDeleteEventPayload event;
