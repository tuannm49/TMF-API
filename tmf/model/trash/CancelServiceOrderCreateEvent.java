...
public class CancelServiceOrderCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "CancelServiceOrderCreateEvent_id")
    ...
    @JsonBackReference
    private CancelServiceOrderCreateEventPayload event;
