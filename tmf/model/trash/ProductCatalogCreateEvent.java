...
public class ProductCatalogCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ProductCatalogCreateEvent_id")
    ...
    @JsonBackReference
    private ProductCatalogCreateEventPayload event;
