...
public class ClosedLoopWorkflowActivityDeleteEvent_MVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopWorkflowActivityDeleteEvent_MVO_id")
    ...
    @JsonBackReference
    private ClosedLoopWorkflowActivityDeleteEventPayload event;
