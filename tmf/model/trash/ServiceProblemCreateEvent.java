...
public class ServiceProblemCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ServiceProblemCreateEvent_id")
    ...
    @JsonBackReference
    private ServiceProblemCreateEventPayload event;
