...
public class ShippingOrderCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ShippingOrderCreateEvent_id")
    ...
    @JsonBackReference
    private ShippingOrderCreateEventPayload event;
