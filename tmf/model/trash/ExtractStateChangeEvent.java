...
public class ExtractStateChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ExtractStateChangeEvent_id")
    ...
    @JsonBackReference
    private ExtractStateChangeEventPayload event;
