...
public class BillingAccountDeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "BillingAccountDeleteEvent_id")
    ...
    @JsonBackReference
    private BillingAccountDeleteEventPayload event;
