...
public class FinancialAccountCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "FinancialAccountCreateEvent_id")
    ...
    @JsonBackReference
    private FinancialAccountCreateEventPayload event;
