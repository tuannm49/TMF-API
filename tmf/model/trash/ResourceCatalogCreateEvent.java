...
public class ResourceCatalogCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ResourceCatalogCreateEvent_id")
    ...
    @JsonBackReference
    private ResourceCatalogCreateEventPayload event;
