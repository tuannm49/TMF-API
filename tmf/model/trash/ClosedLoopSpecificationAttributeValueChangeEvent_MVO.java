...
public class ClosedLoopSpecificationAttributeValueChangeEvent_MVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopSpecificationAttributeValueChangeEvent_MVO_id")
    ...
    @JsonBackReference
    private ClosedLoopSpecificationAttributeValueChangeEventPayload event;
