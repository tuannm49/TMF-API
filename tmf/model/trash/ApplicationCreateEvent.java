...
public class ApplicationCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ApplicationCreateEvent_id")
    ...
    @JsonBackReference
    private ApplicationCreateEventPayload event;
