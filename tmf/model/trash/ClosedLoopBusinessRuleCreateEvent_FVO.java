...
public class ClosedLoopBusinessRuleCreateEvent_FVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopBusinessRuleCreateEvent_FVO_id")
    ...
    @JsonBackReference
    private ClosedLoopBusinessRuleCreateEventPayload event;
