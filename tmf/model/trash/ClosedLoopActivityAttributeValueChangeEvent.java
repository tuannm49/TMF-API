...
public class ClosedLoopActivityAttributeValueChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopActivityAttributeValueChangeEvent_id")
