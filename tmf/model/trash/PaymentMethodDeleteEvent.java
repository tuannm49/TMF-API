...
public class PaymentMethodDeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "PaymentMethodDeleteEvent_id")
    ...
    @JsonBackReference
    private PaymentMethodDeleteEventPayload event;
