...
public class ServiceCatalogCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ServiceCatalogCreateEvent_id")
    ...
    @JsonBackReference
    private ServiceCatalogCreateEventPayload event;
