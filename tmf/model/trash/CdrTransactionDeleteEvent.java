...
public class CdrTransactionDeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "CdrTransactionDeleteEvent_id")
    ...
    @JsonBackReference
    private CdrTransactionDeleteEventPayload event;
