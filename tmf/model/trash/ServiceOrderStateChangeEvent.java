...
public class ServiceOrderStateChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ServiceOrderStateChangeEvent_id")
    ...
    @JsonBackReference
    private ServiceOrderStateChangeEventPayload event;
