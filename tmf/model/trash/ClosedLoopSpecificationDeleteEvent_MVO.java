...
public class ClosedLoopSpecificationDeleteEvent_MVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopSpecificationDeleteEvent_MVO_id")
    ...
    @JsonBackReference
    private ClosedLoopSpecificationDeleteEventPayload event;
