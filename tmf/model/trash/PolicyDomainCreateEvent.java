...
public class PolicyDomainCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "PolicyDomainCreateEvent_id")
    ...
    @JsonBackReference
    private PolicyDomainCreateEventPayload event;
