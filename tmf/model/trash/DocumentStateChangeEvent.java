...
public class DocumentStateChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "DocumentStateChangeEvent_id")
    ...
    @JsonBackReference
    private DocumentStateChangeEventPayload event;
