...
public class ManagedPolicyEventDeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ManagedPolicyEventDeleteEvent_id")
    ...
    @JsonBackReference
    private ManagedPolicyEventDeleteEventPayload event;
