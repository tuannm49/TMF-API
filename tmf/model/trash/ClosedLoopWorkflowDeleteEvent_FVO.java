...
public class ClosedLoopWorkflowDeleteEvent_FVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopWorkflowDeleteEvent_FVO_id")
    ...
    @JsonBackReference
    private ClosedLoopWorkflowDeleteEventPayload event;
