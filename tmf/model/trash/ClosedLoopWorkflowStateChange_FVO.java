...
public class ClosedLoopWorkflowStateChange_FVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopWorkflowStateChange_FVO_id")
    ...
    @JsonBackReference
    private ClosedLoopWorkflowStateChangeEventPayload event;
