...
public class ClosedLoopGoalCreateEvent_MVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopGoalCreateEvent_MVO_id")
    ...
    @JsonBackReference
    private ClosedLoopGoalCreateEventPayload event;
