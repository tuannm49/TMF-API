...
public class GeographicSiteCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "GeographicSiteCreateEvent_id")
    ...
    @JsonBackReference
    private GeographicSiteCreateEventPayload event;
