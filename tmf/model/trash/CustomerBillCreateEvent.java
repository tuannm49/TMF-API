...
public class CustomerBillCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "CustomerBillCreateEvent_id")
    ...
    @JsonBackReference
    private CustomerBillCreateEventPayload event;
