...
public class ProductOrderErrorMessageEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ProductOrderErrorMessageEvent_id")
    ...
    @JsonBackReference
    private ProductOrderErrorMessagePayload event;
