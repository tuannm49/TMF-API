...
public class IntentReportDeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "IntentReportDeleteEvent_id")
    ...
    @JsonBackReference
    private IntentReportDeleteEventPayload event;
