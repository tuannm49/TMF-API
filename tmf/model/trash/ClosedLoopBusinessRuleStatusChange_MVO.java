...
public class ClosedLoopBusinessRuleStatusChange_MVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopBusinessRuleStatusChange_MVO_id")
    ...
    @JsonBackReference
    private ClosedLoopBusinessRuleStatusChangePayload event;
