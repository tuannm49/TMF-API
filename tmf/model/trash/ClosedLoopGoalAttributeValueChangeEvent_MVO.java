...
public class ClosedLoopGoalAttributeValueChangeEvent_MVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopGoalAttributeValueChangeEvent_MVO_id")
