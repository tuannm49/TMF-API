...
public class ServiceCandidateDeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ServiceCandidateDeleteEvent_id")
    ...
    @JsonBackReference
    private ServiceCandidateDeleteEventPayload event;
