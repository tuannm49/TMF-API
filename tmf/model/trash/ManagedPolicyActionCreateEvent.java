...
public class ManagedPolicyActionCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ManagedPolicyActionCreateEvent_id")
    ...
    @JsonBackReference
    private ManagedPolicyActionCreateEventPayload event;
