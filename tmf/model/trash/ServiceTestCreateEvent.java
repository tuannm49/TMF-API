...
public class ServiceTestCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ServiceTestCreateEvent_id")
    ...
    @JsonBackReference
    private ServiceTestCreateEventPayload event;
