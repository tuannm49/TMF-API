...
public class ProductCatalogStateChangeEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ProductCatalogStateChangeEvent_id")
    ...
    @JsonBackReference
    private ProductCatalogStateChangeEventPayload event;
