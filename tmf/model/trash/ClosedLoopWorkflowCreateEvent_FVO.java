...
public class ClosedLoopWorkflowCreateEvent_FVO implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ClosedLoopWorkflowCreateEvent_FVO_id")
    ...
    @JsonBackReference
    private ClosedLoopWorkflowCreateEventPayload event;
