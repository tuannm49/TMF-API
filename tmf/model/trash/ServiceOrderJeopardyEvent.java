...
public class ServiceOrderJeopardyEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "ServiceOrderJeopardyEvent_id")
    ...
    @JsonBackReference
    private ServiceOrderJeopardyEventPayload event;
