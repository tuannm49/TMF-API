...
public class SettlementAccountDeleteEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "SettlementAccountDeleteEvent_id")
    ...
    @JsonBackReference
    private SettlementAccountDeleteEventPayload event;
