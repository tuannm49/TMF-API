...
public class CancelWorkOrderCreateEvent implements java.io.Serializable {
    private String eventId;
    @JsonProperty("@type")
    private String type;
    @OneToMany
    @JoinColumn(name = "CancelWorkOrderCreateEvent_id")
    ...
    @JsonBackReference
    private CancelWorkOrderCreateEventPayload event;
