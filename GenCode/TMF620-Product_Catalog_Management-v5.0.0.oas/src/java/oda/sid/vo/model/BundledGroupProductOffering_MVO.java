...
public class BundledGroupProductOffering_MVO extends Extensible implements java.io.Serializable {
    ...
    @JoinTable(name = "BundledGroupProductOffering_MVO_BundledGroupProductOffering_MVO")
    ...
    private String id;
    @OneToMany(cascade = CascadeType.PERSIST)
    @JoinTable(name = "BundledGroupProductOffering_MVO_BundledProductOffering_MVO")
