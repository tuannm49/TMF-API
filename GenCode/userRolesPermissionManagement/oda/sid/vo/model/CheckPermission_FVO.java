...
public class CheckPermission_FVO extends Entity implements java.io.Serializable {
    @ManyToOne
    ...
    @OneToMany
    @JoinColumn(name = "CheckPermission_FVO_id")
    @JsonManagedReference
    private List<Characteristic_FVO> characteristic;
    @OneToMany
    @JoinColumn(name = "CheckPermission_FVO_id")
    @JsonManagedReference
    private List<EntityRefOrValue_FVO> entity;
}
