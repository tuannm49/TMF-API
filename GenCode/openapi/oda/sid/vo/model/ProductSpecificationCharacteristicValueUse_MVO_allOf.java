...
public class ProductSpecificationCharacteristicValueUse_MVO_allOf implements java.io.Serializable {
    private String name;
    @Id
    private String id;
    ...
    @OneToMany
    @JoinColumn(name = "ProductSpecificationCharacteristicValueUse_MVO_allOf_id")
