...
public class ShippingInstruction_FVO extends Entity implements java.io.Serializable {
    @OneToMany
    @JoinColumn(name = "ShippingInstruction_FVO_id")
    ...
    @JoinColumn(name = "ShippingInstruction_FVO_id")
    @JsonManagedReference
    private List<Characteristic_FVO> instructionCharacteristic;
