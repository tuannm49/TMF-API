...
public class ResourceSpecificationRelationship_FVO extends Extensible_FVO implements java.io.Serializable {
    ...
    @JoinTable(name = "ResourceSpecificationRelationship_FVO_CharacteristicSpecification_FVO")
