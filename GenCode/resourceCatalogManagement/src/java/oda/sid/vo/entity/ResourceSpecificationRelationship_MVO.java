...
public class ResourceSpecificationRelationship_MVO extends Extensible implements java.io.Serializable {
    ...
    @JoinTable(name = "ResourceSpecificationRelationship_MVO_CharacteristicSpecification_MVO")
