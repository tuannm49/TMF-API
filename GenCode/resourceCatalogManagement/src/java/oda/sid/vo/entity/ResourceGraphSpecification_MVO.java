...
public class ResourceGraphSpecification_MVO extends Entity_MVO implements java.io.Serializable {
    private final static long serialVersionUID = 1L;
    private String description;
    @OneToMany(cascade = CascadeType.PERSIST)
    @JoinTable(name = "ResourceGraphSpecification_MVO_ConnectionSpecification_MVO")
    private List<ConnectionSpecification_MVO> connectionSpecification;
    @OneToMany(cascade = CascadeType.PERSIST)
    @JoinTable(name = "ResourceGraphSpecification_MVO_ResourceGraphSpecificationRelationship")
