...
public class CharacteristicSpecification_MVO extends Extensible implements java.io.Serializable {
    ...
    @JoinTable(name = "CharacteristicSpecification_MVO_CharacteristicSpecificationRelationship_MVO")
    private List<CharacteristicSpecificationRelationship_MVO> charSpecRelationship;
    @OneToMany(cascade = CascadeType.PERSIST)
    @JoinTable(name = "CharacteristicSpecification_MVO_CharacteristicValueSpecification_MVO")
