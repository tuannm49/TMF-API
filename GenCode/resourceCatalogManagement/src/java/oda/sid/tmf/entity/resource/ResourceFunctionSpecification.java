...
public class ResourceFunctionSpecification extends LogicalResourceSpecification implements java.io.Serializable {
    ...
    @JoinTable(name = "ResourceFunctionSpecification_ConnectionPointSpecificationRef")
    private List<EntityRef> connectionPointSpecification;
    @OneToMany(cascade = CascadeType.PERSIST)
    @JoinTable(name = "ResourceFunctionSpecification_ResourceGraphSpecification")
