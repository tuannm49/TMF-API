package oda.sid.tmf.entity.others;
...
public class ConnectionSpecification extends AbstractEntity implements java.io.Serializable {
    private final static long serialVersionUID = 1L;
    @OneToMany(cascade = CascadeType.PERSIST)
    @JoinTable(name = "ConnectionSpecification_EndpointSpecificationRef")
    private List<EntityRef> endpointSpecification;
