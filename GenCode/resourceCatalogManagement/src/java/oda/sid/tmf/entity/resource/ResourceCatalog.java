...
public class ResourceCatalog extends Catalog implements java.io.Serializable {
    private final static long serialVersionUID = 1L;
    @OneToMany(cascade = CascadeType.PERSIST)
    @JoinTable(name = "ResourceCatalog_ResourceCategoryRef")
    private List<EntityRef> category;
    @OneToMany(cascade = CascadeType.PERSIST)
    @JoinTable(name = "ResourceCatalog_ExternalIdentifier")
