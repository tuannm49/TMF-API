...
import oda.sid.vo.model.ServiceQualificationItem_FVO;

@Entity
@Data
@Document
@JsonInclude(JsonInclude.Include.NON_NULL)
public class CheckServiceQualificationItem_FVO extends ServiceQualificationItem_FVO implements java.io.Serializable {
    @OneToMany
