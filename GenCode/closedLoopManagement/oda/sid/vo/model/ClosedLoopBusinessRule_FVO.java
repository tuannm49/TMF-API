...
public class ClosedLoopBusinessRule_FVO extends Entity_FVO implements java.io.Serializable {
    ...
    @JsonBackReference
    private EntitySpecificationRef_FVO closedLoopBusinessRuleSpecification;
    @ManyToOne
    @JoinColumn(name = "businessRuleTriggerEvent_id")
    @JsonBackReference
    private EventRef_FVO businessRuleTriggerEvent;
    @ManyToOne
