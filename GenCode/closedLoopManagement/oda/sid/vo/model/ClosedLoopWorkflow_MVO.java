...
public class ClosedLoopWorkflow_MVO extends Entity_MVO implements java.io.Serializable {
    @ManyToOne
    @JoinColumn(name = "closedLoopWorkflowActivity_id")
    @JsonBackReference
    private ClosedLoopWorkflowActivityRef_MVO closedLoopWorkflowActivity;
    ...
    @JsonBackReference
    private ClosedLoopWorkflowPriorityRef_MVO closedLoopWorkflowPriority;
    private String description;
    @ManyToOne
    @JoinColumn(name = "endedBy_id")
    @JsonBackReference
    private Trigger_MVO endedBy;
    @ManyToOne
