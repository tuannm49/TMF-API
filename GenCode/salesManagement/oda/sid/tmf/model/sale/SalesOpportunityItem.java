...
import oda.sid.tmf.model.sale.Extensible;

@Entity
@Data
@Document
@JsonInclude(JsonInclude.Include.NON_NULL)
public class SalesOpportunityItem extends Extensible implements java.io.Serializable {
    @OneToMany
    @JoinColumn(name = "SalesOpportunityItem_id")
