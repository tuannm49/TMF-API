...
public class MeasureThresholdRuleViolation_MVO extends Extensible_MVO implements java.io.Serializable {
    private Boolean conformanceComparatorExact;
    @OneToMany
    @JoinColumn(name = "MeasureThresholdRuleViolation_MVO_id")
    @JsonManagedReference
    private List<AppliedConsequence_MVO> appliedConsequence;
