...
public class ServiceTest_FVO implements java.io.Serializable {
    @ManyToOne
    ...
    @OneToMany
    @JoinColumn(name = "ServiceTest_FVO_id")
    ...
    @JsonBackReference
    private ServiceRef_FVO relatedService;
    @OneToMany
    @JoinColumn(name = "ServiceTest_FVO_id")
    @JsonManagedReference
    ...
    @JsonBackReference
    private ServiceTestSpecificationRef_FVO testSpecification;
    private String mode;
