...
public class ApiProductOrderItemModify extends DCSProductOrderItem implements java.io.Serializable {
    @ManyToOne
    ...
    private String id;
    @OneToMany
    @JoinColumn(name = "ApiProductOrderItemModify_id")
    ...
    @JsonBackReference
    private ApiProductActionModify productAction;
}
