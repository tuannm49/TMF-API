...
public class PaymentMethod_FVO extends Entity_FVO implements java.io.Serializable {
    ...
    @JsonBackReference
    private RelatedParty_FVO relatedParty;
    @OneToMany
    @JoinColumn(name = "PaymentMethod_FVO_id")
