...
public class ServiceSpecification_MVO extends EntitySpecification_MVO implements java.io.Serializable {
    ...
    @JoinTable(name = "ServiceSpecification_MVO_ResourceSpecificationRef_MVO")
    ...
    @OneToMany(cascade = CascadeType.PERSIST)
    @JoinTable(name = "ServiceSpecification_MVO_FeatureSpecification_MVO")
    private List<FeatureSpecification_MVO> featureSpecification;
    @OneToMany(cascade = CascadeType.PERSIST)
    @JoinTable(name = "ServiceSpecification_MVO_ServiceLevelSpecificationRef_MVO")
    private List<ServiceLevelSpecificationRef_MVO> serviceLevelSpecification;
    @OneToMany(cascade = CascadeType.PERSIST)
    @JoinTable(name = "ServiceSpecification_MVO_EntityRelationship_MVO")
